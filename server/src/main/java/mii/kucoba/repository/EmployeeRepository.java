...
public interface EmployeeRepository extends JpaRepository<Employee, Integer>{
    @Query(value = "SELECT * FROM employee WHERE status = 'true'", nativeQuery = true) //nativeQuery = true berarti menandakan bahwa query ini kita buat sendiri
    List<Employee> getTrueEmployee();
